...
source=('septabee_linux_B_T2.7z::https://septabee.nekoweb.org/important_stuff/SEPTABEE_DOWNLOADS/version_B/septabee_linux_B_T2.7z'
  ...
  'septabee.desktop'
  'septabee.png'
  'septabee-jit-abi-8.sbrt::https://septabee.nekoweb.org/important_stuff/llvm-stuffs/abi-8/linux.sbrt'
  'extract-runtime.py')
...
prepare() {
  python "$srcdir/extract-runtime.py" "$srcdir/septabee-jit-abi-8.sbrt" "$srcdir/jit-runtime"
}
...
package() {
  ...
  install -d "$pkgdir/usr/lib/septabee/jit-runtime"
  install -m644 "$srcdir/jit-runtime/"* "$pkgdir/usr/lib/septabee/jit-runtime/"
}
